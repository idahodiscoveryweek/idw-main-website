...
export const metadata: Metadata = {
  title: "Japanese Language & Culture Camp",
  description:
    "Immerse in Japanese language and culture at Idaho Discovery Week. Learn phrases, writing systems, and enjoy traditional foods and customs. Summer 2026 in Meridian, Idaho.",
  openGraph: {
    title: "Japanese Language & Culture Camp | Idaho Discovery Week",
    description:
      "Learn Japanese phrases, writing systems, and experience traditional foods and customs. Summer 2026 camp in Meridian, Idaho.",
    images: [{ url: "/japaneselanguageandculture.jpg" }],
  },
};
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid md:grid-cols-2 gap-6 sm:gap-16 items-start">
              ...
              <div className="space-y-8">
                <div className="bg-red-100 rounded-2xl p-5 sm:p-8 shadow-lg">
                  ...
                  <div className="space-y-4 text-gray-600 text-sm sm:text-lg">
                    <p>
                      ...
                      discover the richness of Japan through language,
                      traditions, and hands-on cultural experiences.
                    </p>
                    <p>
