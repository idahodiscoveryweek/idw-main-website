...
export const metadata: Metadata = {
  title: "Drawing From Life Camp",
  description:
    "Develop fundamental drawing skills at Idaho Discovery Week's Drawing From Life camp. Learn to draw organic objects, create a self-portrait, and take home a beginner drawing kit. Summer 2026 in Meridian, Idaho.",
  openGraph: {
    title: "Drawing From Life Camp | Idaho Discovery Week",
    description:
      "Develop drawing skills, create a self-portrait, and take home a beginner drawing kit. Summer 2026 camp in Meridian, Idaho.",
    images: [{ url: "/drawingfromlife.jpg" }],
  },
};
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            <div>
              <div className="flex items-center justify-between gap-2 sm:gap-3 mb-4 sm:mb-6">
                ...
                <a
                  href="#register"
                  className="hidden sm:flex items-center gap-2 bg-white text-amber-600 px-6 py-3 rounded-full font-label font-bold text-sm shadow-lg hover:translate-y-[-2px] transition-all duration-300 hover:shadow-xl shrink-0"
                >
              ...
              <a
                href="#register"
                className="sm:hidden mt-4 inline-flex items-center gap-2 bg-white text-amber-600 px-5 py-2.5 rounded-full font-label font-bold text-sm shadow-lg hover:translate-y-[-2px] transition-all duration-300 hover:shadow-xl"
              >
                <span className="material-symbols-outlined text-lg">
                  how_to_reg
                </span>
              ...
              <div className="space-y-8">
                <div className="bg-green-100 rounded-2xl p-5 sm:p-8 shadow-lg">
                  ...
                  <div className="space-y-4 text-gray-600 text-sm sm:text-lg">
                    <p>
                      In our Drawing From Life program, students discover the
                      joy of artistic expression through observation, technique,
                      and imagination.
                    </p>
                    <p>
                      From basic sketching to advanced shading techniques,
                      you'll develop the skills to capture the world around you
