...
export const metadata: Metadata = {
  title: "Programs",
  description:
    "Explore Idaho Discovery Week's summer 2026 programs — Electronics & Circuitry and Drawing From Life. Hands-on camps for kids in Meridian, Idaho.",
  openGraph: {
    title: "Programs | Idaho Discovery Week",
    description:
      "Explore our summer 2026 programs — Electronics and Drawing camps for kids in Meridian, Idaho.",
  },
};
