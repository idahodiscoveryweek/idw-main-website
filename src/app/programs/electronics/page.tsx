              ...
              <div className="bg-blue-100 rounded-2xl p-5 sm:p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-xl p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Create a display dashboard that shows vital signs of your
                      spaceship, including power levels, oxygen status, and
                      navigation data.
                    </p>
                  </div>
                  <div className="bg-white rounded-xl p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Build a real spaceship gaming system that you get to take
                      home and play with friends and family.
                    </p>
                  </div>
                </div>
              </div>
